...
public class UpcomingMovies extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieList = dataSource.getUpcomingMovies();
        dataSource.close();
                            ...
                            Request.newMeRequest(session, new Request.GraphUserCallback() {
                                ...
                                public void onCompleted(GraphUser user, Response response) {
                                    if (user != null) {
                                        ...
                                        Toast.makeText(UpcomingMovies.this, user.getName() + " Logged In...", Toast.LENGTH_LONG).show();
                                    }
                                }
                            }).executeAsync();
                        }
                ...
                .setOnCompleteListener(new WebDialog.OnCompleteListener() {
                    ...
                    public void onComplete(Bundle values,
                        ...
                        if (error == null) {
                            ...
                            if (postId != null) {
                                Toast.makeText(UpcomingMovies.this,
                                        "Posted story, id: "+postId,
                                        Toast.LENGTH_SHORT).show();
                            } else {
                                // User clicked the Cancel button
                                Toast.makeText(UpcomingMovies.this.getApplicationContext(),
                                        "Publish cancelled",
                                        Toast.LENGTH_SHORT).show();
                            }
    ...
    private void loadSearchData(String query, SearchView search){
        ...
        Cursor cursor = db.getWordMatches(query, MoviesDataSource.allColumns, MovieDBOpenHelper.TABLE_UPCOMING_MOVIES);
    ...
    private class MyTask extends AsyncTask<String, String, List<Movie>> {
        ...
        protected void onPostExecute(List<Movie> result) {
            ...
            for(Movie movie: movieList){
                dataSource.addToUpcomingMovies(movie);
            }
            dataSource.close();
            updateDisplay();
        }
