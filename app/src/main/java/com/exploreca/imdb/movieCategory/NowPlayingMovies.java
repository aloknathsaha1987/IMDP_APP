 ...
 */
public class NowPlayingMovies extends ListActivity {

    public static final String API_VERSION = "3";
    public static final String CONTEXT_PATH = "movie/now_playing";
    public static final String CONTEXT_PATH_GENRE = "genre/list";
    ...
    public static Map<String,Integer> genreMap = new Hashtable<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasks = new ArrayList<>();
        movieList = dataSource.getNowPlayingMovies();
        dataSource.close();

        if(movieList.isEmpty() || genreList.isEmpty()){
            if (isOnline()) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem item = menu.findItem(R.id.menu_now_playing);
    ...
    private void loadSearchData(String query, SearchView search){
        ...
        Cursor cursor = db.getWordMatches(query, MoviesDataSource.allColumns, MovieDBOpenHelper.TABLE_NOW_PLAYING);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case 1:
                ...
                intent.putExtra("genreID", genreMap.get("Action"));
                startActivity(intent);
                break;

            case 2:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Adventure"));
                startActivity(intent);
                break;

            case 3:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Animation"));
                startActivity(intent);
                break;

            case 4:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Comedy"));
                startActivity(intent);
                break;
            ...
            case 5:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Crime"));
                startActivity(intent);
                break;
            ...
            case 6:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Documentary"));
                startActivity(intent);
                break;
            ...
            case 7:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Drama"));
                startActivity(intent);
                break;

            case 8:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Family"));
                startActivity(intent);
                break;
            ...
            case 9:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Fantasy"));
                startActivity(intent);
                break;
            ...
            case 10:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Foreign"));
                startActivity(intent);
                break;
            ...
            case 11:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("History"));
                startActivity(intent);
                break;
            ...
            case 12:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Horror"));
                startActivity(intent);
                break;
            ...
            case 13:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Music"));
                startActivity(intent);
                break;
            ...
            case 14:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Mystery"));
                startActivity(intent);
                break;
            ...
            case 15:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Romance"));
                startActivity(intent);
                break;
            ...
            case 16:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Science Fiction"));
                startActivity(intent);
                break;
            ...
            case 17:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("TV Movie"));
                startActivity(intent);
                break;
            ...
            case 18:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Thriller"));
                startActivity(intent);
                break;
            ...
            case 19:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("War"));
                startActivity(intent);
                break;
            ...
            case 20:
                intent = new Intent(this, GenreSelected.class);
                intent.putExtra("genreID", genreMap.get("Western"));
                startActivity(intent);
                break;
    ...
    private class MyGenre extends AsyncTask<String, String, List<Genre>>{

        @Override
        protected List<Genre> doInBackground(String... params) {
            String content = HttpManager.getData(params[0], API_VERSION, CONTEXT_PATH_GENRE, API_KEY);
        ...
        protected void onPostExecute(List<Genre> result) {
            ...
            if (result == null) {
                Toast.makeText(NowPlayingMovies.this, "Web service not available", Toast.LENGTH_LONG).show();
                return;
            }
            genreList = result;
            ...
            for(int i = 0; i < genreList.size(); i++){
                ...
                genreMap.put(genre.getGenreType(), genre.getId());
                //Toast.makeText(NowPlayingMovies.this, genreMap.get(genre.getGenreType()), Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private class MyTask extends AsyncTask<String, String, List<Movie>> {
        ...
        protected void onPostExecute(List<Movie> result) {
            ...
            movieList = result;
            // Add the movies list to the database
            MoviesDataSource dataSource = new MoviesDataSource(context);
            dataSource.open();
            for(Movie movie: movieList){
                dataSource.addToNowPlayingMovies(movie);
            }
            dataSource.close();
            updateDisplay();
